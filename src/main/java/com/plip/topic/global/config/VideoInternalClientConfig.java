...
@Configuration
@Profile("!test")
@EnableConfigurationProperties(VideoInternalProperties.class)
public class VideoInternalClientConfig {

	private static final String INTERNAL_API_KEY_HEADER = "X-Internal-Api-Key";

	@Bean
	RestClient videoInternalRestClient(VideoInternalProperties properties) {
